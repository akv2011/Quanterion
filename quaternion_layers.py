...
class QuaternionTransposeConvComplexKit(Module):
    r"""Applies a Complex Transposed Convolution (or Deconvolution) to the incoming data.
    """
    ...
    def __init__(self, in_channels, out_channels, kernel_size, stride, operation,
                 dilation=1, padding=0, output_padding=0, groups=1, bias=True, init_criterion='he',
                 weight_init='complexKit', seed=None, rotation=False,
                 quaternion_format=False):

        super(QuaternionTransposeConvComplexKit, self).__init__()
        ...
        self.winit             = {'quaternion': quaternion_init,
                                  'unitary'   : unitary_init,
                                  'random'    : random_init,
                                  "complexKit": complexKit_init}[self.weight_init]
...
class QuaternionTransposeConv2DcomplexKit(Module):
    r"""Applies a Complex Transposed Convolution (or Deconvolution) to the incoming data.
    """

    def __init__(self, in_channels, out_channels, kernel_size, stride,
                 dilation=1, padding=0, output_padding=0, groups=1, bias=True, init_criterion='he',
                 weight_init='complexKit', seed=None, operation='convolution2d', rotation=False,
                 quaternion_format=False): 
    ...
    #              quaternion_format=False):
        ...
        super(QuaternionTransposeConv2DcomplexKit, self).__init__()
...
class QuaternionConvComplexKit(Module):
    r"""Applies a complex Convolution 1-D to the incoming data. conv1d 
    """
    ...
    def __init__(self, in_channels, out_channels, kernel_size, stride,
                 dilation=1, padding=0, groups=1, bias=True, init_criterion='glorot',
                 weight_init='complexKit', seed=None, operation='convolution1d', rotation=False, quaternion_format=True, scale=False):

        super(QuaternionConvComplexKit, self).__init__()
...
class QuaternionConv2d(Module):
    r"""Applies a Quaternion Convolution 2-D to the incoming data.
    """
...
class QuaternionConv2dcomplexKit(Module):
    r"""Applies a Complex Convolution 2-D to the incoming data.
    """
    ...
    def __init__(self, in_channels, out_channels, kernel_size, stride,
                 dilation=1, padding=0, groups=1, bias=True, init_criterion='glorot',
                 weight_init='complexKit', seed=None, operation='convolution2d', rotation=False, quaternion_format=True, scale=False):

        super(QuaternionConv2dcomplexKit, self).__init__()
...
class QuaternionConv2dUni(Module):
    r"""Applies a Quaternion Convolution 2D unitary initilisation to the incoming data.
    """
